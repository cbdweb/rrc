...
public class PolylineEncoder {
	...
	public static void main(String[] args) {
		...
		trk.addTrackpoint(new Trackpoint(new Double(52.29834), new Double(8.94328)));
		trk.addTrackpoint(new Trackpoint(new Double(52.29767), new Double(8.93614)));
		trk.addTrackpoint(new Trackpoint(new Double(52.29322), new Double(8.93301)));
		trk.addTrackpoint(new Trackpoint(new Double(52.28938), new Double(8.93036)));
		trk.addTrackpoint(new Trackpoint(new Double(52.27014), new Double(8.97475)));
